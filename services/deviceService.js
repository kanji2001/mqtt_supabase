...
exports.addDevice = async (macaddress) => {
  ...
  if (existingDevice) throw { status: 400, message: 'MAC address already exists' };
  ...
  if (userError || !users.length) throw { status: 400, message: 'No users available with remaining quantity' };
